...
class BottomSheetMapMenu extends StatelessWidget {
  const BottomSheetMapMenu({super.key});

  @override
  Widget build(BuildContext context) {
    return Consumer<UINotifiersModel>(builder: (_, uiNotifiersModel, __) {
      return Consumer<MapModel>(builder: (_, mapModel, __) {
        return Consumer<CurrentRideCreationModel>(
            builder: (_, currentRideCreationModel, __) {
          return Container(
                          ...
                          children: <Widget>[
                            ...
                            CarouselSlider(
                              options: CarouselOptions(
                                ...
                                onPageChanged:
                                    currentRideCreationModel.carTypeChanged,
                              ),
                                ...
                                child: Padding(
                                  ...
                                  child: Text(
                                    mapModel.checkDestinationOriginForNull()
                                        ? "Etimated amount : ${currentRideCreationModel.getEstimationFromOriginDestination()} Rupees"
