...
class _MainScreenState extends State<MainScreen> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Material(
      child: Consumer<UINotifiersModel>(builder: (_, uiNotifiersModel, __) {
        return Consumer<UserDetailsModel>(builder: (_, userDetailsModel, __) {
            ...
            return Scaffold(
                ...
                body: Stack(
                  children: <Widget>[
                    SlidingUpPanel(
                      onPanelSlide:
                          uiNotifiersModel.setOriginDestinationVisibility,
                      onPanelOpened: () {
                      ...
                      body: GoogleMap(
                        style: context.read<MapStyle>().value,
